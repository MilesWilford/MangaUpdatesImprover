// ==UserScript==
// @name MangaUpdatesImprover
// @include http://*mangaupdates.com/releases.html*
// @include https://*mangaupdates.com/releases.html*
// @require libs/jquery-2.1.1.min.js
// @require libs/handlebars-v1.3.0.min.js
// ==/UserScript==
...
console.log('end of messaging api');

// Check for locally-stored groups array first
if (typeof localStorage.groups === 'undefined' || !localStorage.groups.length > 0) {
